...
function mergeLanguageOptions(base: PartialProfileConfig, overwriteConfig: PartialProfileConfig): void {
    ...
    if (!baseLangOpts.parserOptions) baseLangOpts.parserOptions = overwriteParserOpts
    else mergeConfigDeep(baseLangOpts.parserOptions as Record<string, unknown>, overwriteParserOpts, ['parser'])
}
